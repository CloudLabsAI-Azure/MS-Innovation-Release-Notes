...
Welcome to the **Hack the Stack - Azure AI Apps & Databases** Readme.md. In this page, we will document the changes made during the last testing cycle, including updates related to the infrastructure, content, screenshots, and other relevant changes for the lab.
...
- Updated screenshots with latest UI as well as also added few instructions and improve the overall experience.
