...
- Tested the lab end to end, all validations were successful. Updated the lab guide for better clarity.
...
- **Minor updates**: 
    ...
    - **Updated UI Screenshots**: Replaced screenshots to match the latest UI.
